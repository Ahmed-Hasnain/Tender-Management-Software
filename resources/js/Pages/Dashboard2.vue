                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="m-t-30" style="height: 150px">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="rating-chart" height="187"
                                style="display: block; height: 150px; width: 225px;" width="281"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="m-t-50" style="height: 225px">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="sales-chart" width="662" height="281"
                                style="display: block; height: 225px; width: 530px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center position-relative m-v-50" style="height:150px;">
                            <div class="w-100 position-absolute" style="height:150px; top:0;">
                                <canvas class="chart m-h-auto" id="porgress-chart" width="375" height="187"
                                    style="display: block; height: 150px; width: 300px;"></canvas>
                            </div>
