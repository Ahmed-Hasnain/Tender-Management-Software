                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                            <label>Search:
                                                <search :url="'dashboard.client.person.search'"
                                                    :searchedKeyword="searchedKeyword" :id="client.id"></search>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <pagination :meta="allPeople" :keyword="searchedKeyword" :company_id="client.id"></pagination>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    props: ["client", "people", "searchedKeyword"],
    components: {
        AuthenticatedLayout,
        Head,
        Error,
